...
function Main() {
  return (
    <>
      ...
      <div className="about">
        <h2>About</h2>
        <p>I am a fullstack developer from Latvia. I'm still a student at the moment. I love programming all day long without interrupting. In between programming, I like to spend time outside, or play computer games with friends.</p>
